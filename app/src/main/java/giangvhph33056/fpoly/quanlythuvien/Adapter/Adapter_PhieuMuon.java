...
import giangvhph33056.fpoly.quanlythuvien.Dao.PhieuMuonDao;
import giangvhph33056.fpoly.quanlythuvien.Dao.SachDao;
import giangvhph33056.fpoly.quanlythuvien.Dao.ThanhVienDao;
import giangvhph33056.fpoly.quanlythuvien.Model.PhieuMuon;
...
public class Adapter_PhieuMuon extends RecyclerView.Adapter<Adapter_PhieuMuon.ViewHolder> {
    ...
    public Adapter_PhieuMuon(ArrayList<PhieuMuon> list, Context context) {
        this.list = list;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView txtMaPM, txtTenTV, txtTenSach, txtNgay, txtTrangThai, txtTienThue;
        ImageView PM_Delete;
    ...
    private void dialogUpdatePM(PhieuMuon pm) {
        ...
        PM_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean check = dao.updateTrangThai(id);
